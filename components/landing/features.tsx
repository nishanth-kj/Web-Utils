            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="p-8 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1">
                        ...
                        <h3 className="text-xl font-bold mb-3">File Editor</h3>
                        <p className="text-zinc-500 dark:text-zinc-400">Professional editing environment with support for multiple formats and real-time syntax validation.</p>
                    </div>
                    <div className="p-8 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1">
                        <div className="size-12 rounded-2xl bg-purple-500/10 flex items-center justify-center text-purple-500 mb-6">
                            <Code2 className="size-6" />
                        </div>
                        <h3 className="text-xl font-bold mb-3">Power IDE</h3>
                        <p className="text-zinc-500 dark:text-zinc-400">Advanced IDE features including smart formatting, intelligent snippets, and multi-pane development views.</p>
                    </div>
                    <div className="p-8 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1">
