        ...
        <footer className="py-12 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
            <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4 text-zinc-500 text-sm order-2 md:order-1">
                    ...
                    <span>© 2026 Web Utils Pro. Built by <a href="https://github.com/nishanth-kj" target="_blank" rel="noreferrer" className="text-zinc-900 dark:text-white font-bold hover:text-indigo-600 transition-colors">Nishanth K J</a>.</span>
                </div>
