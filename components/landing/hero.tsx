...
export function Hero() {
    return (
        <section className="relative pt-20 pb-20 px-4 md:pt-40 md:pb-32 overflow-hidden">
            {/* Background Glows */}
            <div
                className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-500px bg-linear-to-b from-indigo-500/10 via-transparent to-transparent blur-3xl -z-10"/>
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10">
                ...
                <h1 className="text-5xl md:text-[5.5rem] font-black tracking-tight mb-10 leading-[1.05] bg-clip-text text-transparent bg-linear-to-br from-zinc-950 via-zinc-800 to-zinc-600 dark:from-white dark:via-zinc-200 dark:to-zinc-500">
            ...
            <div className="max-w-5xl mx-auto mt-24 px-4 animate-in fade-in zoom-in-95 duration-1000 delay-300">
                <div className="relative group">
                    <div
                        className="absolute -inset-1 bg-linear-to-r from-indigo-500 to-purple-600 rounded-[2.5rem] blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
                    <div className="relative aspect-video rounded-[2.5rem] bg-zinc-900 border border-white/10 shadow-2xl overflow-hidden">
                        <div
                            className="absolute inset-0 bg-linear-to-tr from-indigo-500/5 via-transparent to-purple-500/5"/>
