...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* This is what handles the sidebar gap on desktop - Removed to prevent pushing content */}
      <div
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-7 z-[300]", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
      {...props}
    >
      {isMobile ? <Menu className="size-5" /> : <PanelLeftIcon />}
